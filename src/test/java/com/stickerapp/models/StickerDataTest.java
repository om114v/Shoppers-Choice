...
/**
 * Comprehensive unit tests for StickerData class.
 * Tests cover constructors, getters/setters, toString method,
 * validation method, and various input scenarios including edge cases.
 */
...
public class StickerDataTest {
    ...
    class ParameterizedTests {
        ...
        @ParameterizedTest
        @CsvSource({
            "'Item A', 'Supplier A', 10.50, 5",
            "'Item B', 'Supplier B', 0.01, 1",
            "'', '', 999.99, 100",
        ...
        @ParameterizedTest
        @CsvSource({
            "'Valid Item', 'Valid Supplier', 10.00, 5, true",
            "'', 'Supplier', 10.00, 5, false",
            "'Item', '', 10.00, 5, false",
            "'Item', 'Supplier', 0.00, 5, false",
            "'Item', 'Supplier', 10.00, 0, false",
            "'Item', 'Supplier', -5.00, 5, false",
            "'Item', 'Supplier', 10.00, -1, false"
        })
        @DisplayName("Should validate data correctly")
        void testValidationParameterized(String itemName, String supplierName, BigDecimal price, int numberOfStickers, boolean expectedValid) {
            StickerData data = new StickerData(itemName, supplierName, price, numberOfStickers);

            assertEquals(expectedValid, data.validate());
        }
        ...
        void testToStringParameterized(String itemName, String supplierName, BigDecimal price, int numberOfStickers, String expected) {
            StickerData data = new StickerData(itemName, supplierName, price, numberOfStickers);
    ...
    class EdgeCasesTests {
        ...
        void testMinimumIntegerStickers() {
            ...
            assertFalse(data.validate()); // Because negative stickers
        }
        ...
        void testBigDecimalDifferentScales() {
            ...
            assertTrue(data1.validate());
            assertTrue(data2.validate());
            assertTrue(data3.validate());
